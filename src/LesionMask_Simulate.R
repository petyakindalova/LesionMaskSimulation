...
#install.packages("neurobase", repos="http://cran.r-project.org", lib="/well/nichols/users/kindalov/FMRIB/local_libs/")
library(neurobase, lib.loc="/well/nichols/users/kindalov/FMRIB/local_libs/")


#install.packages("sp", repos="http://cran.r-project.org", lib="/well/nichols/users/kindalov/FMRIB/local_libs/")
library(sp, lib.loc="/well/nichols/users/kindalov/FMRIB/local_libs/")

#install.packages("RandomFieldsUtils", repos="http://cran.r-project.org", lib="/well/nichols/users/kindalov/FMRIB/local_libs/")
library(RandomFieldsUtils, lib.loc="/well/nichols/users/kindalov/FMRIB/local_libs/")

#install.packages("RandomFields", repos="http://cran.r-project.org", lib="/well/nichols/users/kindalov/FMRIB/local_libs/")
library(RandomFields, lib.loc="/well/nichols/users/kindalov/FMRIB/local_libs/")


#install.packages("fslr", repos="http://cran.r-project.org", lib="/well/nichols/users/kindalov/FMRIB/local_libs/")
library(fslr, lib.loc="/well/nichols/users/kindalov/FMRIB/local_libs/")


#load the brain mask
brain_mask = readNIfTI("/well/nichols/users/kindalov/FMRIB/MNI152_T1_2mm_brain_mask.nii.gz")
empir_prob = readNIfTI("/well/nichols/users/kindalov/FMRIB/CVR_application/Analysis_Nov2019/GLM_age/temp/empir_prob_mask.nii.gz")
#-----------------------------------------------------------------------------------------------------------
...
coef_age_ukbb = readNIfTI("/well/nichols/users/kindalov/FMRIB/CVR_application/Analysis_Nov2019/GLM_age/results/coef_age_nvars_1_method_2.nii.gz")
coef_intercept_ukbb = readNIfTI("/well/nichols/users/kindalov/FMRIB/CVR_application/Analysis_Nov2019/GLM_age/results/coef_(Intercept)_nvars_1_method_2.nii.gz")
#print("UKBB mean age")
#mean(coef_age_ukbb)
...
write.table(nsubj_dataframe[,1:3],
            file=paste0(workdir, "/", "GLM_sample1000.dat"),
            row.names=FALSE, sep="\t", quote=FALSE)
